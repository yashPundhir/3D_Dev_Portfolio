...
const Hero = () => {
	return (
		<section className="relative w-full h-[730px] mx-auto">
			<div
				className={`${styles.paddingX} absolute inset-0 top-[200px] max-w-7xl mx-auto flex flex-row items-start gap-5 z-10`}
			>
